    ...
    controls: [
      {
        ...
        connector: "Code Labs V105 unified",
      ...
      {
        control: "queue_reviewed_operation",
        connector: "Code Labs V105 unified",
        tool: "run_code_labs_action",
      ...
      {
        control: "execute_reviewed_github_operation",
        connector: "Code Labs V105 unified",
        tool: "independent V105 GitHub operation tools",
        writes:
          "one reviewed operation on an existing non-protected branch and one draft PR where applicable",
        requires_code_god_pass: true,
      },
      {
