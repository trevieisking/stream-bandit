...
function css(){
  ...
  s.textContent='.sbSocialShareBar{display:flex;gap:7px;flex-wrap:wrap;align-items:center;margin:8px 0}.sbSocialShareBtn{border:0;border-radius:999px;padding:8px 10px;background:linear-gradient(135deg,#41e8ff,#7c3cff);color:#061017;font-weight:950;cursor:pointer}.sbSocialShareBar.blocked{border:1px solid #ffb14266;border-radius:14px;background:#ffb14220;color:#ffe8b8;padding:9px 11px;font-weight:850}.sbSocialShareBtn:focus{outline:2px solid #fff;outline-offset:2px}';
