/* Stream Bandit V5.24.1 — Live Tools Link to V5.24.1 Tools Page
   Keeps a safe Tools page link in the live menu only.
   Removes any repeated Tools cards from Admin/Supabase Manager.
   Helper tools remain standalone on tools-v5-24-1.html.
   tools-v5-20-2.html remains available as rollback fallback.
   No Supabase writes, no movie saves, no Mux, no player, no Sound Booster, no database changes. */
(function(){
'use strict';

var VERSION='V5.24.1';
var TOOLS_URL='tools-v5-24-1.html';
