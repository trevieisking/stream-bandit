...
var titles={main:'Watch',browse:'Browse',supabase:'Supabase',mux:'Mux',storage:'Storage',admin:'Admin Tools'};
...
function organise(){
  ...
  if(side){Array.prototype.slice.call(side.querySelectorAll('.sb56Badge')).forEach(function(x){x.remove();});}
