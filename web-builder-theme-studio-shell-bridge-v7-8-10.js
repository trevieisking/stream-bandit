/* Stream Bandit V7.8.10 Theme Studio Shell Bridge
   Adds the standard header/search host to the existing V7.8.9 Theme Studio page so shared menu/search/auth scripts can attach. */
(function(){
'use strict';
function start(){
