(function(){
'use strict';
const VERSION='V7.12.87 Global Brand Logo Helper + Supabase Library Footer';
...
function installSupabaseLibraryFooter(){
  if(!isSupabaseLibraryPage())return;
  ...
  footer.innerHTML='<div class="sb-global-footer-grid"><div class="sb-global-footer-col"><b>Stream Bandit</b><small>Supabase Library live-polish pass V7.12.87. Payments disabled until billing is designed.</small></div><div class="sb-global-footer-col"><b>Watch</b><a href="home-global-helpers-v7-4-4-test.html">Home</a><a href="details-clean-machine-v7-12-38-test.html">Details</a><a href="player-one-global-helpers-v7-3-3-test.html">Player 1</a></div><div class="sb-global-footer-col"><b>Browse</b><a href="library-global-helpers-v7-4-8-test.html">Library</a><a href="global-search-global-helpers-v7-4-9-test.html">Search</a><a href="genres-clean-machine-v7-12-45-test.html">Genres</a></div><div class="sb-global-footer-col"><b>Admin</b><a href="supabase-library-home-header-form-fix-v7-12-34-test.html">Supabase Library</a><a href="review-queue-clean-machine-v7-12-55-test.html">Review Queue</a><a href="storage-prep-global-helpers-v7-10-8-test.html">Storage Prep</a></div></div>';
  wrap.appendChild(footer);
  document.documentElement.dataset.streamBanditGlobalFooter='supabase-library-v7-12-87';
}
function refresh(){
  const url=safeApply(logoUrl());
  installSupabaseLibraryFooter();
  return url;
}
function install(){
