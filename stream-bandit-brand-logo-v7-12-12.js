...
const VERSION='V7.12.226 Global Brand Logo Helper / Settings Read + Social Actions Loader';
...
const SOCIAL_ACTIONS_SRC='stream-bandit-social-actions-v7-13-002.js?v=brand-loader-7-12-226';
const SOCIAL_PAGES={
...
function loadSocialActionsIfNeeded(){try{if(!isSocialPage())return;let base=SOCIAL_ACTIONS_SRC.split('?')[0];if(Array.from(document.scripts||[]).some(s=>String(s.src||'').includes(base)))return;let s=document.createElement('script');s.src=SOCIAL_ACTIONS_SRC;s.defer=true;s.dataset.sbLoadedBy='brand-logo-helper-v7-12-226';document.head.appendChild(s);document.documentElement.dataset.sbSocialActionsLoader='brand-logo-v7-12-226';}catch(e){}}
