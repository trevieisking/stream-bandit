...
- Storage Prep uploads allowed images when signed in.
...
- Pages Manager V7.12.221 opens.
- Header appears.
- Global Footer Shell appears once only.
- Saved counters and account panel work.
- Page list loads 5 `sb_site_pages` rows.
- Filter pages and status filter work.
- `test-page` selection works.
- Builder route points to `web-builder-live-studio-v7-12-116-test.html?page=test-page`.
- Published Preview route points to `web-builder-shared-style-preview-v7-12-117-test.html?page=test-page`.
- Advanced Form route points to `web-builder-form-save-v7-12-94-test.html?page=test-page`.
- Form Inbox route points to `web-builder-form-submissions-v7-12-94-test.html?page=test-page`.
- New page draft works locally.
- Clear form works.
...
- `CHECKPOINT-PAGES-MANAGER-HAZARD-MAP-V7-12-111.md`
- `CHECKPOINT-PAGES-MANAGER-SHELL-ROUTE-PASS-V7-12-220.md`
- `CHECKPOINT-PAGES-MANAGER-DUPLICATE-FOOTER-HOTFIX-PASS-V7-12-221.md`

## Web Builder future architecture note

Current builder tools live inside Stream Bandit. Future direction is to make Web Builder its own Builder Studio workspace with its own builder-specific shell/menu and a clear Back to Stream Bandit link.
