...
function activeGroup(){let c=cur();for(const g of GROUPS){if(g[1].some(x=>same(x[1],c)))return g[0];}return 'Watch';}
function css(){if(document.getElementById('sbFooterShellCss'))return;let s=document.createElement('style');s.id='sbFooterShellCss';s.textContent=':root{--sbLine:var(--line,#ffffff22);--sbP:var(--p,#101529);--sbP2:var(--p2,#17122d);--sbA:var(--accent,#22d3a6);--sbA2:var(--accent2,#7c3cff);--sbM:var(--muted,#b9c0d8)}.sb-old-page-footer-hidden,#sbCollectionsFooter,#sbPlayer2Footer,.microFooter{display:none!important;visibility:hidden!important;opacity:0!important;height:0!important;min-height:0!important;max-height:0!important;overflow:hidden!important;margin:0!important;padding:0!important;border:0!important}.sb-footer-shell{border:1px solid var(--sbLine);border-radius:24px;background:linear-gradient(135deg,var(--sbP),var(--sbP2));box-shadow:0 14px 48px #0007;padding:14px;margin:14px 0;color:#fff}.sb-footer-top{display:grid;grid-template-columns:minmax(220px,1fr) 2.4fr;gap:12px;align-items:start}.sb-footer-brand{border:1px solid #ffffff18;border-radius:18px;background:#ffffff0b;padding:12px}.sb-footer-brand h2{font-size:22px;margin:0 0 5px}.sb-footer-brand p{margin:0 0 6px;color:var(--sbM);line-height:1.35}.sb-footer-brand small{color:var(--sbM)}.sb-footer-tabs{display:flex;flex-wrap:wrap;gap:7px;align-items:center}.sb-footer-tab{border:1px solid #ffffff20;border-radius:999px;background:#ffffff12;color:#baf7df;font-weight:950;padding:8px 11px;cursor:pointer}.sb-footer-tab.current{background:linear-gradient(135deg,var(--sbA),var(--sbA2));color:#061017;border-color:#ffffff55}.sb-footer-panel{margin-top:12px;border:1px solid #ffffff18;border-radius:18px;background:#ffffff0b;padding:12px}.sb-footer-panel-head{display:flex;justify-content:space-between;gap:10px;align-items:center;margin-bottom:8px}.sb-footer-panel-head b{color:#baf7df}.sb-footer-links{display:grid;grid-template-columns:repeat(auto-fit,minmax(180px,180px));gap:10px;justify-content:start;align-items:stretch}.sb-footer-links a{display:flex;align-items:center;justify-content:center;text-align:center;color:#baf7df;text-decoration:none;font-weight:950;border-radius:15px;background:#ffffff0e;border:1px solid #ffffff12;padding:10px 12px;width:180px;min-width:180px;max-width:180px;height:54px;min-height:54px;max-height:54px;line-height:1.1;overflow:hidden}.sb-footer-links a.current{color:#fff;background:linear-gradient(135deg,#22d3a638,#7c3cff38);border-color:#22d3a670;box-shadow:0 0 0 2px #22d3a618}.sb-footer-note{margin-top:10px;text-align:center;color:#8f98b8;font-size:12px}@media(max-width:900px){.sb-footer-top{grid-template-columns:1fr}.sb-footer-tab{flex:1;min-width:88px}.sb-footer-links{grid-template-columns:repeat(auto-fit,minmax(155px,155px));justify-content:center}.sb-footer-links a{width:155px;min-width:155px;max-width:155px;height:50px;min-height:50px;max-height:50px}}@media(max-width:520px){.sb-footer-shell{padding:12px}.sb-footer-tabs{display:grid;grid-template-columns:repeat(2,1fr)}.sb-footer-links{grid-template-columns:1fr;justify-content:stretch}.sb-footer-links a{width:100%;min-width:0;max-width:none;height:48px;min-height:48px;max-height:48px}}';document.head.appendChild(s);}
function hideOld(){try{let w=document.querySelector('.wrap')||document.body;Array.from(w.children).forEach(el=>{if(el.id!=='sbFooterShell'&&el.matches&&el.matches('section.footer,.footer,footer,#sbCollectionsFooter,#sbPlayer2Footer'))el.classList.add('sb-old-page-footer-hidden');});document.querySelectorAll('#sbCollectionsFooter,#sbPlayer2Footer,.microFooter').forEach(el=>el.classList.add('sb-old-page-footer-hidden'));}catch(e){}}
function applyTheme(){try{if(window.StreamBanditThemeProjector&&window.StreamBanditThemeProjector.refresh)window.StreamBanditThemeProjector.refresh();else if(window.StreamBanditSettingsGlobal&&window.StreamBanditSettingsGlobal.refresh)window.StreamBanditSettingsGlobal.refresh();}catch(e){}document.documentElement.dataset.sbThemeReaderFooter='footer-shell';}
