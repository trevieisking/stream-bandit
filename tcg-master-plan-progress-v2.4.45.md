...
Set One Standard/base PNG masters verified at canonical paths: **9/193**.
Astral verified: **9/24**.
...
The current ledger sequence indicates `astral-starwhale` next, but the workflow requires a fresh GitHub preflight again immediately before its image is generated.
