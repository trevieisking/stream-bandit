(function(){
  ...
  var VERSION = 'V7.13.026 Unified Route Registry + Manic Records + Manic Studio';
  ...
  var ROUTES = [
    ...
    {label:'Manic Studio',url:'manic-studio.html',group:'Music',shell:SHELLS.MAIN_APP,routeClass:ROUTE_CLASSES.ACCOUNT_OPTIONAL,read:['sb_profiles'],write:[]},
    ...
    {label:'Pages Source Map',url:'web-builder-pages-source-map-v7-12-255-test.html',group:'Web Builder',shell:SHELLS.WEB_BUILDER,routeClass:ROUTE_CLASSES.WEB_BUILDER_OWNER,read:['sb_profiles'],write:[]},
