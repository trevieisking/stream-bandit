/* Stream Bandit V7.12.33 Shared Shell Route Guard
   Safe UI/router pass only: grouped drawer, global search, favicon and route guard.
   No saves, uploads, deletes, billing, permission writes, database writes or live/index promotion. */
(function(){
'use strict';

const VERSION='V7.12.33 Shared Shell Route Guard';
...
const ROUTE_FIXES={
 ...
 'details-global-helpers-v7-3-0-test.html':'details-global-helpers-v7-3-1-test.html',
 ...
 'favourites-watch-shell-v6-38-test.html':'favourites-global-helpers-v7-3-6-test.html',
 ...
 'supabase-library-browse-shell-v6-43-test.html':'supabase-library-clean-editor-v6-93-3-test.html',
 ...
 'platform-builder-admin-shell-v6-58-test.html':'platform-control-tower-live-machine-route-doctor-v7-12-32-test.html',
...
const pages=[
['🏠','Home','home-global-helpers-v7-4-4-test.html','Watch home current'],
['🎬','Details','details-global-helpers-v7-3-1-test.html','Single-title Details current'],
...
['⭐','Favourites','favourites-global-helpers-v7-3-6-test.html','Personal saved list'],
...
['🟢','Supabase Library','supabase-library-clean-editor-v6-93-3-test.html','Supabase library editor/current'],
...
['🧱','Platform Control Tower','platform-control-tower-live-machine-route-doctor-v7-12-32-test.html','Live Machine Route Doctor'],
...
['🔎','Original Global Search','global-search-v5-90-test.html','Legacy reference'],
['🎨','Original Settings Studio','settings-controls-v5-81-test.html','Legacy reference'],
['🧭','Original Final Shell','final-shell-navigation-v5-79-test.html','Legacy reference'],
['🚦','Original Live Readiness','live-readiness-standalone-v5-64-test.html','Legacy reference'],
...
const groupOrder=['Watch','Browse','Group Play','Creator','Settings','Admin','User Management','Policy','Legacy / Reference'];
...
function applyRouteGuard(root=document){try{root.querySelectorAll&&root.querySelectorAll('a[href],form[action],[data-href],[data-target],[data-route],[data-url]').forEach(el=>{['href','action','data-href','data-target','data-route','data-url'].forEach(attr=>{const val=el.getAttribute&&el.getAttribute(attr);if(!val)return;const fixed=fixedRouteValue(val);if(fixed!==val){el.setAttribute(attr,fixed);el.dataset.sbRouteGuard='fixed';}});});document.documentElement.dataset.streamBanditRouteGuard='v7-12-33';}catch(e){}}
