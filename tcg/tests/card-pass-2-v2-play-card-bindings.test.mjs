...
test('Battle keeps the accepted v0.7 geometry and v0.8 play bindings while adding the shared card-face bridge', () => {
  ...
  assert.match(battle, /stream-bandit-tcg-v2-battle-controller\.js\?v=0-13-touch-drag/);
  assert.match(controller, /Stream Bandit TCG V2 Battle Controller v0\.13-touch-drag/);
});
