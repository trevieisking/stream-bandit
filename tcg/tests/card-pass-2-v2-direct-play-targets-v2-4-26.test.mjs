...
test('V2.4.28 visual cache identity advances without changing gameplay or renderer identity', () => {
  assert.match(html, /data-sb-tcg-tabletop="v2-4-26"/);
  assert.match(html, /stream-bandit-tcg-battle-table-v2-4-7\.css\?v=2-4-28/);
  assert.match(html, /stream-bandit-tcg-v2-battle-controller\.js\?v=2-4-28/);
