# Code Labs Menu Route Agreement V130/V146
...
Support/proof pages such as Project Picker, Connection Guide, Read-Only Proof, Help, FAQ, About, Helper Route Map, and receipts may remain available, but they must not replace the prep route or the main repair workflow above.
