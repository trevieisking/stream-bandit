/* Code Labs Code God protected-page polish V275. */
(function(){
'use strict';
if(!document.body||document.body.getAttribute('data-page')!=='code-god')return;
var VERSION='V275-source-modes';
var LINKS=[
...
function loadRepositoryFamily(){if(q('script[data-cl-repository-family-v259]'))return;var s=document.createElement('script');s.src='assets/code-labs-repository-family-v259.js?v=cl-v259-repository-family';s.setAttribute('data-cl-repository-family-v259','yes');document.head.appendChild(s)}
function loadSourceModes(){if(q('script[data-cl-code-god-source-modes-v275]'))return;var s=document.createElement('script');s.src='assets/code-god-source-modes-v275.js?v=cl-v275-code-god-source-modes';s.setAttribute('data-cl-code-god-source-modes-v275','yes');document.head.appendChild(s)}
...
function boot(){[0,80,220,600,1200].forEach(function(delay){window.setTimeout(decorate,delay)});loadRepositoryFamily();loadSourceModes();window.CodeLabsCodeGodPolishV222={version:VERSION,decorate:decorate}}
