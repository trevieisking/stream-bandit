/* Code Labs Code God protected-page polish V278. */
(function(){
'use strict';
if(!document.body||document.body.getAttribute('data-page')!=='code-god')return;
var VERSION='V278-review-retirement';
var LINKS=[
...
function boot(){[0,80,220,600,1200].forEach(function(delay){window.setTimeout(decorate,delay)});load('assets/code-labs-repository-family-v259.js?v=cl-v259-repository-family','data-cl-repository-family-v259');load('assets/code-god-source-modes-v275.js?v=cl-v275-code-god-source-modes','data-cl-code-god-source-modes-v275');load('assets/code-god-fallback-v276.js?v=cl-v276-code-god-fallback','data-cl-code-god-fallback-v276');load('assets/code-god-review-state-v278.js?v=cl-v278-code-god-review-state','data-cl-code-god-review-state-v278');window.CodeLabsCodeGodPolishV222={version:VERSION,decorate:decorate}}
