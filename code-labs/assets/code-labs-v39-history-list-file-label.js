/* Code Labs V3.9 - show saved file row in Supabase Repair History list */
(function(){
  'use strict';
  ...
  async function loadHistoryWithFiles(){
    ...
    try{
      ...
      setHelp('<p><b>Supabase:</b> history cards now show the saved file row, not old project text.</p>');
  ...
  function hook(){
    ...
    if(!api.__v39FileLabelList){
      api.loadHistory=loadHistoryWithFiles;
      api.__v39FileLabelList=true;
    }
