/* Code Labs Buddy Canvas compatibility loader V200.12. */
(function () {
  'use strict';
  ...
  function loadShells() {
    ...
    script.src = 'assets/cl-nav.js?v=cl-v200-14-shell-entry';
  ...
  function run() {
    ...
    var side = ruleBox();
    if (side) {
      side.setAttribute('data-cl-buddy-lane-rule', 'V200.12');
