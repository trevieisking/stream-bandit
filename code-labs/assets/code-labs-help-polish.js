...
var top=main.firstElementChild;main.insertBefore(dash,top);main.insertBefore(quick,dash.nextSibling);main.insertBefore(search,quick.nextSibling);
if(safe)main.insertBefore(safe,search.nextSibling);if(raw)main.insertBefore(raw,safe?safe.nextSibling:search.nextSibling);if(diff)main.insertBefore(diff,raw?raw.nextSibling:search.nextSibling);if(html)main.insertBefore(html,diff?diff.nextSibling:search.nextSibling);if(local)main.insertBefore(local,html?html.nextSibling:search.nextSibling);if(backup)main.insertBefore(backup,local?local.nextSibling:search.nextSibling);if(info)main.appendChild(info);if(lane)main.appendChild(lane);
