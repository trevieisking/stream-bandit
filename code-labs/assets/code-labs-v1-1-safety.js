...
function loadClarity(){if(q('script[data-cl-workflow-clarity-v129]'))return;var s=document.createElement('script');s.src='assets/code-labs-workflow-clarity-v129.js?v=cl-workflow-clarity-v129';s.setAttribute('data-cl-workflow-clarity-v129','yes');document.head.appendChild(s)}
