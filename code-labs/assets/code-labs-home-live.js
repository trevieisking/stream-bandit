/* Code Labs V4.1 - About page linked */
(function(){
  'use strict';
  ...
  function addNav(){
    ...
    if(!q('a[href="about.html"]',n)){n.appendChild(navItem('about.html','ℹ️','About','What Code Labs does'))}
  ...
  function render(){
    ...
    main.innerHTML=(top?top.outerHTML:'')+
      '<section class="hero" id="clHomeLiveCentre"><div><span class="pill">Simple Code Labs flow</span><h1>Fix website code with one clear path.</h1><p>Use Code Labs as a focused browser workbench. It helps non-coders load a full file, explain the problem, get ChatGPT repair guidance, paste the fixed file, preview it, keep a checkpoint, then finish in Repo Desk for controlled GitHub follow-up.</p><div class="actions"><a class="btn primary" href="file-lab.html">Start: File Lab</a><a class="btn ghost" href="about.html">About Code Labs</a><a class="btn ghost" href="rescue-room.html">Open Rescue Room</a><a class="btn ghost" href="patch-desk.html">Open Patch Desk</a><a class="btn good" href="repo-desk.html">Final: Repo Desk</a><a class="btn ghost" href="help.html">60-second help</a><a class="btn ghost" href="faq.html">FAQ</a></div></div><div class="heroCard"><b>Main flow</b><ol><li>File Lab: load or paste code.</li><li>Rescue Room: check the repair path.</li><li>Workflow Hub: ask ChatGPT.</li><li>Patch Desk: paste the fixed file.</li><li>Preview + Test: check before promotion.</li><li>Checkpoints: keep rollback.</li><li>Repo Desk: controlled GitHub follow-up.</li></ol></div></section>'+ 
      '<section class="panel"><h2>Use Code Labs in 60 seconds</h2><div class="grid3"><div class="item"><b>1. Start with the full file</b><p>Use File Lab to load or paste the complete broken file. Full files stop hidden logic being lost.</p></div><div class="item"><b>2. Preview and checkpoint first</b><p>Use Rescue Room, Workflow Hub, Patch Desk, Preview + Test, then Checkpoints before any GitHub follow-up.</p></div><div class="item"><b>3. Finish in Repo Desk</b><p>Repo Desk is the final lane for controlled GitHub request preparation and PR tracking.</p></div></div><div class="actions"><a class="btn ghost" href="about.html">Read About Code Labs</a><a class="btn good" href="rescue-room.html">Open Rescue Room</a><a class="btn ghost" href="v20.html">Open Workflow Hub</a><a class="btn good" href="repo-desk.html">Final: Repo Desk</a><a class="btn ghost" href="help.html">Open Help</a><a class="btn ghost" href="faq.html">Open FAQ</a></div></section>'+ 
      ...
      step(5,'Preview + Test','Open the fixed result before promotion. Keep the check simple: opens, buttons visible, no obvious break.','preview-test.html','Preview','ghost')+
      step(6,'Checkpoints','Save rollback/test notes before GitHub follow-up.','checkpoints.html','Checkpoint','ghost')+
      step(7,'Repo Desk','Finish here for controlled GitHub request preparation and PR tracking.','repo-desk.html','Final step','good')+
      '</section>'+ 
      '<section class="panel"><h2>About Code Labs</h2><p>Code Labs exists to help people who cannot code actually patch website problems with ChatGPT support. The About page gives users and search summaries the correct explanation.</p><div class="actions"><a class="btn primary" href="about.html">Open About Code Labs</a><a class="btn good" href="file-lab.html">Start repair flow</a></div></section>'+ 
      '<section class="panel"><h2>Final GitHub step</h2><p>Repo Desk is the last step in the Code Labs flow. It prepares controlled GitHub follow-up after preview and checkpoint notes are saved.</p><div class="actions"><a class="btn good" href="repo-desk.html">Open final Repo Desk</a><a class="btn ghost" href="checkpoints.html">Back to Checkpoints</a><a class="btn ghost" href="faq.html">Open FAQ</a></div></section>'+ 
      '<div class="footerNote">Code Labs V4.1 · About page added · Repo Desk is the final workflow step for controlled GitHub follow-up.</div>';
    addNav();
  }
