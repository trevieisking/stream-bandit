/* Code Labs V3.0 - Home Command Centre live user wording */
(function(){
  'use strict';
  ...
  function render(){
    ...
    main.innerHTML=(top?top.outerHTML:'')+
      ...
      '</section>'+ 
      '<section class="panel"><h2>Live promotion status</h2><div class="grid"><div class="item"><b>Passed pages</b><p>File Lab and Workflow Hub have passed live review. Continue through the menu checklist from Home, Start Guide, and Fix Wizard next.</p></div><div class="item"><b>Manual first</b><p>Code Labs can work without connectors by copy/paste, Patch Desk, Patch Lab, preview, checkpoints, export, and handoff.</p></div><div class="item"><b>GitHub connector works</b><p>Use ChatGPT GitHub connector for repo reads, test branches, PRs, previews, merges, and verified cleanup after the signed-in user connects GitHub.</p></div><div class="item"><b>Supabase separate</b><p>Use Code Labs tables for repair history only when Supabase is connected. No Stream Bandit login redirects or buttons.</p></div></div></section>'+ 
      '<section class="panel"><h2>Safe publish lane</h2><div class="grid"><div class="item"><b>New file cleanup rule</b><p>Before any new repo file is created, verify three old Stream Bandit V4/V5/V6 pages or checkpoint files for cleanup. Never delete V7 or Code Labs pages for this rule.</p></div><div class="item"><b>One connector at a time</b><p>Use GitHub for repo work or Supabase for Code Labs history work. Do not mix both in the same pass unless the user explicitly switches.</p></div></div><div class="actions"><a class="btn ghost" href="patch-desk.html">Patch Desk</a><a class="btn ghost" href="patch-lab.html">Patch Lab</a><a class="btn ghost" href="connector-status.html">Connector status</a><a class="btn ghost" href="repo-desk.html">Repo Desk</a><a class="btn ghost" href="checkpoints.html">Checkpoints</a><a class="btn ghost" href="preview-test.html">Preview + Test</a></div></section>'+ 
      '<div class="footerNote">Code Labs V3.0 Home Command Centre · durable ChatGPT workbench · signed-in user wording · File Lab and Workflow Hub passed.</div>';
  }
