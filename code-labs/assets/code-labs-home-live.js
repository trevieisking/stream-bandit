/* Code Labs V2.7 - Home Command Centre */
(function(){
  'use strict';
  ...
  function render(){
    ...
    main.innerHTML=(top?top.outerHTML:'')+
      ...
      '</section>'+
      '<section class="panel"><h2>Safe publish lane</h2><div class="grid"><div class="item"><b>Manual first</b><p>Code Labs can work without connectors by copy/paste, preview, and checkpoints.</p></div><div class="item"><b>GitHub later</b><p>Use GitHub for test branches, PRs, previews, and merges only after user approval.</p></div><div class="item"><b>Supabase separate</b><p>Use Code Labs tables only. No Stream Bandit page redirects or buttons.</p></div></div><div class="actions"><a class="btn ghost" href="connector-status.html">Connector status</a><a class="btn ghost" href="checkpoints.html">Checkpoints</a><a class="btn ghost" href="preview-test.html">Preview + Test</a></div></section>'+
      '<div class="footerNote">Code Labs V2.7 Home Command Centre · File Lab, Code Search, Workflow Hub, Patch Desk, and Preview are now the main flow.</div>';
  }
