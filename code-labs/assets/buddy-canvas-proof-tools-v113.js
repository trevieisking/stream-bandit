/* Code Labs Buddy Canvas V113 - local proof tools */
(function(){
'use strict';
...
function expose(){window.CodeLabsBuddyCanvasProofTools={version:'V113',proof:proofObject,proofReport:proofReport,links:function(){return findLinks(source()||preview()||fixed());},linkReport:linkReport,buildChunks:buildChunks};}
function boot(){ensureUi();expose();renderProof();setInterval(function(){if(q('#clProofPanel'))renderProof();},3000);}
