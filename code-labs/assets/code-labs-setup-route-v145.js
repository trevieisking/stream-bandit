/* Code Labs Setup Route V251 - canonical Home -> Setup -> Project Picker -> File Lab. No writes. */
(function(){
'use strict';
...
function run(){keepSetup();fixRoutePanels();watch();document.body.setAttribute('data-code-labs-setup-route-v145','active');window.CodeLabsSetupRouteV145={version:'V251',active:true,route:'Home -> Setup -> Project Picker -> File Lab'}}
