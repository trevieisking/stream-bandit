/* Code Labs Setup Route V145/V146 - keeps Setup after Home and routes Setup directly to File Lab. No writes. */
(function(){
'use strict';
...
function rewriteProjectPickerLinks(){qa('a[href="project-picker.html"]').forEach(function(a){a.href='file-lab.html';if(/next/i.test(a.textContent||''))a.textContent='Next: File Lab';else if(/project/i.test(a.textContent||''))a.textContent='File Lab'})}
...
function run(){keepSetup();fixRoutePanels();watch();document.body.setAttribute('data-code-labs-setup-route-v145','active');window.CodeLabsSetupRouteV145={version:'V146',active:true,route:'Home -> Setup -> File Lab'}}
